    ...
    >
      <div className="relative overflow-hidden rounded-2xl">
        <div className="md:w-[24rem]">
          <Image src="/GZ.png" alt="" width={700} height={700} />
        </div>
      ...
      <div className="md:w-[50%] flex flex-col gap-5">
        <h1 className="text-2xl font-semibold">Aircraft ID Quiz</h1>
        <p className="text-sm leading-6 text-gray-300">
          Being an effective virtual pilot in the skies of IL-2 1946 on realistic settings requires quickly identifying friend
          or foe and decisive tactical decision making. A quick quiz here will help you build these skills. Up for a challenge?
          Identify the aircraft in the images!
        </p>
        <Link
